...
public class ImageUtil {
	...
	public static void saveMinPhoto(String srcURL, String deskURL,
		...
		tag.getGraphics()
				.drawImage(
						src.getScaledInstance(deskWidth, deskHeight,
								Image.SCALE_SMOOTH), 0, 0, deskWidth,
						deskHeight, null); // 绘制缩小后的图
		File file = new File(deskURL);// 抽象一个1.txt的文件，处理文件名或者路径
		FileOutputStream deskImage = new FileOutputStream(file); // 输出到文件流
