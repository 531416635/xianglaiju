...
<!-- ===================================
	FONTS ICON
==================================== -->
<link rel="stylesheet" href="<%=path%>/css/font-awesome/css/font-awesome.css">

<!-- ===================================
	PLUGIN
==================================== -->
<link rel="stylesheet" href="<%=path%>/css/magnific-popup.css">
<link rel="stylesheet" href="<%=path%>/css/slider-pro.css">
<link rel="stylesheet" href="<%=path%>/css/owl.carousel.css">
<link rel="stylesheet" href="<%=path%>/css/owl.theme.css">
<link rel="stylesheet" href="<%=path%>/css/owl.transitions.css">
...
<link rel="stylesheet" href="<%=path%>/css/color-green.css" id="colors" />
	...
	<nav class="navbar clean-main-menu" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<!-- Logo -->
				<a class="navbar-brand" href="index.html"><img class="logo" id="logo" src="<%=path%>/images/logo.png" alt="Page"></a>
...
<section class="slider-pro clean-slider" id="clean-slider">
	<div class="sp-slides">
		...
		<div class="sp-slide clean-main-slides">
			...
			<img class="sp-image" src="<%=path%>/images/slider/1.jpg" alt="Slider 1"/>
		...
		<div class="sp-slide clean-main-slides">
			...
			<img class="sp-image" src="<%=path%>/images/slider/3.jpg" alt="Slider 3"/>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-sm-6 col-xs-12 clean-custom-sec-img wow bounceInLeft">
				<img src="<%=path%>/images/custom.jpg" alt="Custom Image">
			</div>
			...
			<div class="clean-portfolio-work-slider-section wow fadeIn" data-wow-duration="2s">
				<div id="featured-work-slider" class="owl-carousel clean-portfolio-works-slider">
					...
					<div class="clean-portfolio-work-item">
						...
						<img src="<%=path%>/images/featured-work/1.png" alt="Feature Work 1">
						<div class="clean-port-work-details">
							<ul class="clean-work-meta">
								<li class="clean-lighbox"><a href="<%=path%>/images/featured-work/1.png" class="clean-featured-work-img"><i class="fa fa-cog"></i></a></li>
							</ul>
						</div>
					...
					<div class="clean-portfolio-work-item">
						...
						<img src="<%=path%>/images/featured-work/2.png" alt="Feature Work 2">
						<div class="clean-port-work-details">
							<ul class="clean-work-meta">
								<li class="clean-lighbox"><a href="<%=path%>/images/featured-work/2.png" class="clean-featured-work-img"><i class="fa fa-cog"></i></a></li>
							</ul>
						</div>
					...
					<div class="clean-portfolio-work-item">
						...
						<img src="<%=path%>/images/featured-work/3.png" alt="Feature Work 3">
						<div class="clean-port-work-details">
							<ul class="clean-work-meta">
								<li class="clean-lighbox"><a href="<%=path%>/images/featured-work/3.png" class="clean-featured-work-img"><i class="fa fa-cog"></i></a></li>
							</ul>
						</div>
					...
					<div class="clean-portfolio-work-item">
						...
						<img src="<%=path%>/images/featured-work/4.png" alt="Feature Work 4">
						<div class="clean-port-work-details">
							<ul class="clean-work-meta">
								<li class="clean-lighbox"><a href="<%=path%>/images/featured-work/4.png" class="clean-featured-work-img"><i class="fa fa-cog"></i></a></li>
							</ul>
						</div>
					...
					<div class="clean-portfolio-work-item">
						...
						<img src="<%=path%>/images/featured-work/5.png" alt="Feature Work 5">
						<div class="clean-port-work-details">
							<ul class="clean-work-meta">
								<li class="clean-lighbox"><a href="<%=path%>/images/featured-work/5.png" class="clean-featured-work-img"><i class="fa fa-cog"></i></a></li>
							</ul>
						</div>
					...
					<div class="clean-portfolio-work-item">
						...
						<img src="<%=path%>/images/featured-work/6.png" alt="Feature Work 6">
						<div class="clean-port-work-details">
							<ul class="clean-work-meta">
								<li class="clean-lighbox"><a href="<%=path%>/images/featured-work/6.png" class="clean-featured-work-img"><i class="fa fa-cog"></i></a></li>
							</ul>
						</div>
					...
					<div class="clean-portfolio-work-item">
						...
						<img src="<%=path%>/images/featured-work/7.png" alt="Feature Work 7">
						<div class="clean-port-work-details">
							<ul class="clean-work-meta">
								<li class="clean-lighbox"><a href="<%=path%>/images/featured-work/7.png" class="clean-featured-work-img"><i class="fa fa-cog"></i></a></li>
							</ul>
						</div>
				...
				<div id="clean-testimonial" class="owl-carousel clean-testimonial">
					...
					<div class="clean-testimonial-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1"> 
						<div class="clean-member-img-wrapper">
							<img src="<%=path%>/images/testimonial/1.png" alt="Team Member 2">
						</div>
					...
					<div class="clean-testimonial-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">
						<div class="clean-member-img-wrapper">
							<img src="<%=path%>/images/testimonial/2.png" alt="Team Member 2">
						</div>
					...
					<div class="clean-testimonial-slides col-md-8 col-sm-10 col-xs-12 col-md-offset-2 col-sm-offset-1">
						<div class="clean-member-img-wrapper">
							<img src="<%=path%>/images/testimonial/3.png" alt="Team Member 2">
						</div>
	...
	<div class="container">
		<div class="row">
			<div class="clean-footer-content">
				...
				<p class="clean-copyright-info">Copyright &copy; 2017.Company name All rights reserved.<a target="_blank" href="http://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
...
<script src="<%=path%>/js/jquery.sliderPro.min.js"></script>
<script src="<%=path%>/js/owl.carousel.min.js"></script>
<script src="<%=path%>/js/jquery.easypiechart.js"></script>
...
<script src="<%=path%>/js/jquery.nav.js"></script>
